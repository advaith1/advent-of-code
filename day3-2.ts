const text = `..........................................389.314.................206......................449.523..................138.....................
.........+.....954......723..........................................*.............687.....*..........692..........*........................
...
for (const [lineInd, line] of Object.entries(lines)) {
	let numStr = ''
	let numStart = -1
	for (const [charInd, char] of Object.entries([...line, '.'])) {
		if (char >= '0' && char <= '9') {
			if (numStart < 0) numStart = +charInd
			numStr += char
		} else {
			if (numStr) {
				numbers.push({
...
for (const s of symbols) {
	if (s.sym === '*') {
		const adjNumbers = numbers.filter(n =>
			(s.ind >= n.start - 1 && s.ind <= n.end + 1) &&
			(s.line === n.line || s.line === n.line - 1 || s.line === n.line + 1)
		)
		console.log(adjNumbers)
		if (adjNumbers.length === 2) gearRatios.push(adjNumbers[0].num * adjNumbers[1].num)
	}
}

let sum = 0
for (const r of gearRatios) sum += r
console.log(sum)
